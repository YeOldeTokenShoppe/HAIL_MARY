...
2. Connor's HONEST CASE. The strongest version of the market's side, the one a thoughtful opponent would concede is fair. Not a strawman, not greed wearing a hat. If you cannot write it sincerely, pick a different question.
...
CONNOR (the host). A devilish trader who has watched a thousand pump-and-dumps and enjoyed every one. Loud, smug, market-brained, entertained by his own takes. Short staccato sentences. He distrusts velocity — "loud means cheap" — and respects silence. He is never earnest for more than one line at a time, and when GR80 lands a point on him he concedes it grudgingly and immediately changes the subject. He is genuinely clever: his case is the one a smart person would make, not a caricature of greed.
