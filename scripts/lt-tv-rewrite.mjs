...
import { LINE_RE, CUE_RE, SEGMENT_RE, CUT_MARK_RE, PAUSE_MARK_RE, TAKE_MARK_RE, parseScript } from "./lt-tv-edit.mjs";
...
export function findMarks(text) {
  ...
  lines.forEach((line, index) => {
    ...
    if (CUT_MARK_RE.test(line) || PAUSE_MARK_RE.test(line) || TAKE_MARK_RE.test(line)) return;
