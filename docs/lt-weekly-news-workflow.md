...
| `Monk` | Saint GR80 | `bZ2WrEjNzHgFHfLLaFKQ` | `gr80` | `Monk_Empty` | `monk_*` |
...
> Note: GR80 has had four voices. `JBFqnCBsd6RMkjVDRZzb` recorded the July
> 2026 test episode, `fATgBRI8wg5KkDFg8vBd` followed it, and the cast moved to
> `Re5c3vCmpnygdZuSX2Wc` on 2026-09-21, then to `bZ2WrEjNzHgFHfLLaFKQ` on 2026-09-22. None of them is wrong; each is what some
...
- **A face beat** is written the same way, `(Connor smile @ +0.5s)`, and SitePal
  ...
  grin, sad, angry, afraid, disgusted, surprised, thinking and wink
  (`src/lib/ltTv/faces.mjs`, which also holds each one's strength and length).
