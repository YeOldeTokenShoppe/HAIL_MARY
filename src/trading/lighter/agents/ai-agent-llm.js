...
class AITradingAgent {
  ...
  async callAnthropic(prompt, systemPrompt = "You are RL80, an expert crypto features/trading AI. Provide sharp, confident analysis.") {
    ...
    try {
      if (consultant === 'sentiment') {
        ...
        const prompt = `Analyze this crypto market data:
          ...
          Provide features/trading insight in 1-2 sentences.`;
