...
export const COIN_CARDS = [
  ...
  coin("demon-desk", "Demon Desk", "DMON", "hype", RARITIES.RARE, 8, 13, 6,
    caseRef("rug", "celeb-shill", "Connor's desk seeded it; Connor's desk exited it. He calls it tuition. Day 30.")),
...
export const ACTION_CARDS = [
  ...
  action("forked-rumor", "Forked Rumor", "hype", RARITIES.COMMON, 2, "Gain +9 portfolio.", { portfolio: 9 },
    kit("lensKey", "demon", "Connor slides you his 2 strongest evidence cards.")),
  action("market-sermon", "Market Sermon", "hype", RARITIES.COMMON, 1, "Gain +6 portfolio. Connor gains +4 more.", { portfolio: 6 },
    kit("lensKey", "demon", "Connor slides you his 2 strongest evidence cards.")),
  action("fomo-cascade", "FOMO Cascade", "pump", RARITIES.COMMON, 3, "Gain +12 portfolio. Connor gets extra edge.", { portfolio: 12 },
    kit("lensKey", "demon", "Connor slides you his 2 strongest evidence cards.")),
  ...
  action("pump-signal", "Pump Signal", "pump", RARITIES.UNCOMMON, 2, "+10 portfolio. Connor gets extra edge.", { portfolio: 10 },
    kit("deepScan", "demon", "Deep scan — Connor traces the pump to its source: everything the hype still hides.")),
  action("exit-liquidity", "Exit Liquidity", "risk", RARITIES.UNCOMMON, 1, "Gain +14 portfolio. Lose 2 Cred.", { portfolio: 14, cred: -2 },
    kit("deepScan", "demon", "Deep scan — Connor maps the exits: everything the sellers still hide.")),
...
export const MARKET_CARDS = [
  ...
  market("meme-season", "Meme Season", RARITIES.RARE, "Hype traders gain +10 portfolio. Others gain +3.", { styleBonus: { hype: 10 }, portfolioAll: 3 },
    docket(1, "Everything with a dog on it is up. Connor looks smug.", "NEXT CASE PAYS ×1.25", { payoutMult: 1.25 })),
  ...
  market("regulator-sweep", "Regulator Sweep", RARITIES.RARE, "Hype traders lose 6 portfolio. Analysis traders gain 5.", { styleBonus: { analysis: 5 }, stylePenalty: { hype: -6 } },
    docket(1, "Subpoenas for the hype desk. Connor takes the fifth.", "PATHOS KIT CARDS DISABLED NEXT CASE", { disableLens: "demon" })),
