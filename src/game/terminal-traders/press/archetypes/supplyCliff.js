...
export const SLOTS = [
  {
    ...
    loadBearing: true,
    lead: "Supply is the question everyone should ask and most ask too late.",
...

  {
    ...
    loadBearing: false,
    lead: "On liquidity — whether you can actually get out at a fair price.",
...

  {
    ...
    loadBearing: false,
    lead: "Distribution matters more than a holder count, so here's the shape of it.",
...

  {
    ...
    loadBearing: false,
    lead: "The treasury has rules about its own selling, which is rarer than it should be.",
...

  {
    ...
    loadBearing: false,
    lead: "My own position first, since it colours how you hear the rest.",
...

  {
    ...
    loadBearing: false,
    lead: "The schedule has already been tested twice, and that's the useful part.",
...

  {
    ...
    shape: SHAPES.UNSOURCED,
    loadBearing: false,
    lead: "Underneath the token there's a business, and it's being used.",
