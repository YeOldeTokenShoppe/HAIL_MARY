  ...
  return (
    <html lang="en" data-theme="dark" data-scroll-behavior="smooth" suppressHydrationWarning style={{ margin: 0, padding: 0 }}>
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Bitcount+Single+Ink&family=Crimson+Pro:ital,wght@0,400;0,500;0,600;1,400;1,500&family=Orbitron:wght@400;700;800;900&family=UnifrakturCook&family=UnifrakturMaguntia&display=swap" rel="stylesheet" />
