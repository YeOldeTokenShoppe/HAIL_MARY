  ...
  return (
    <div style={{
      ...
      {/* {deviceDetected && !isMobileDevice && !isPortalZoomed && (
        ...
        {/* Nav Controls - desktop only, hidden when buy modal is open or portal is zoomed */}
        {!isMobileDevice && !carouselBuyModalOpen && !isPortalZoomed && (
          <NavControlsHome
            isPlaying={contextIsPlaying}
            onPlayMusic={() => play()}
            onStopMusic={() => pause()}
