...
const CONTRACT_ADDRESS = "0xde7Cc5B93e0c1A2131c0138d78d0D0a33cc36e42";
export const abi = [
  {
    inputs: [
  ...
  { inputs: [], name: "RL80__AllowanceExceeded", type: "error" },
  { inputs: [], name: "RL80__ExceedsMaximumHoldingAmount", type: "error" },
  { inputs: [], name: "RL80__TradingNotEnabled", type: "error" },
  { inputs: [], name: "RL80__UpkeepNotNeeded", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [],
    name: "s_features/tradingEnabled",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [],
    name: "s_features/tradingStartTime",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_reducedTaxRate", type: "uint256" },
    ],
    name: "setTaxRates",
    outputs: [],
    stateMutability: "nonpayable",
