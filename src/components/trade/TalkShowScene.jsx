...
// HOLLY'S ARE MICHELLE'S OWN, fitted on the set 2026-09-22 and pasted back.
// They started as a copy of PROMOS_SITEPAL_CROP in src/lib/vendorSitePal.js —
// she is also the promotions hologram at the prize wheel, on the same SitePal
// avatar — and the seed was close but not right, which is worth knowing before
// copying a vendor config for the next character. What moved: the box grew
// (151x154 to 168x169) and shifted down and right, so the borrowed crop was
// cutting into her face; and brightness came DOWN from 115 to 92 while
// saturation and contrast went up, because the prize wheel is a lit booth and
