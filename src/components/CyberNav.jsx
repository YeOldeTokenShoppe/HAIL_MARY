...
const CyberNav = ({ 
  ...
  const navItems = [
    ...
    { id: '02', date: 'LIGHT UTIL80', title: 'THE ILLUMIN80', path: '/shrine', thumbnail: '/images/tinyCandleButton.webp' },
    { id: '03', date: 'PRAYER & PROBABIL80', title: 'TRADING DESK', path: '/trade', thumbnail: '/images/3ACES_TATTOO.webp' },
