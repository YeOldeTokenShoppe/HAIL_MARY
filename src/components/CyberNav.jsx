...
const CyberNav = ({ 
  ...
  const navItems = [
    ...
    { id: '02', date: 'LIGHT UTIL80', title: 'THE ILLUMIN80', path: '/illumin80', thumbnail: '/images/SKULL_TATTOO.webp' },
    { id: '03', date: 'PRAYER & PROBABIL80', title: 'TRADE SCHOOL', path: '/trade', thumbnail: '/images/3ACES_TATTOO.webp' },
    { id: '04', date: 'ETHICS & MORAL80', title: 'SCROLLS OF ST. GR80', path: '/philosophy', thumbnail: '/images/ILLUMIN80_TATTOO.webp' },
    { id: '05', date: 'HOPE & CHAR80', title: 'COIN FOUNTAIN', path: '/fountain', thumbnail: '/images/HEART_TATTOO.webp' },
    { id: '06', date: 'QUANT80 & CURIOS80', title: 'TOKENOMICS & FAQ', path: '/tokenomics', thumbnail: '/images/DIAMOND_TATTOO.webp' },
