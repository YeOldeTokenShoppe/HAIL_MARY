...
const CyberNav = ({
  ...
  // from other portals on document.body (e.g. Clerk modals), preventing
  // removeChild errors during concurrent DOM operations like sign-out.
  useEffect(() => {
    const el = document.createElement('div');
    el.id = 'cybernav-portal';
  ...
  const navItems = [
    ...
    { id: '02', date: t('cyberNav.nav03.date'), title: t('cyberNav.nav03.title'), path: '/tokenomics', thumbnail: '/images/DIAMOND_TATTOO2.webp' },
  ...
  return (
      <>
        ...
        {isMenuOpen && portalContainerRef.current && ReactDOM.createPortal(
          <div
            style={{
              position: "fixed",
              top: "0",
              ...
              padding: isMobile ? "60px 20px calc(40px + env(safe-area-inset-bottom, 20px))" : isSmallTabletLandscape ? "15px 20px" : "40px 20px",
              paddingTop: isMobile ? "60px" : isSmallTabletLandscape ? "15px" : "40px",
              isolation: "isolate",
