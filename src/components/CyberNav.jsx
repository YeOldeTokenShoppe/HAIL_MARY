...
const CyberNav = ({ 
  ...
  const navItems = [
    ...
    { id: '01', date: 'DEFI GRAV80', title: 'SOMETHING ABOUT RL80', path: '/about', thumbnail: '/images/ROSE_TATTOO.webp' },
        { id: '03', date: 'QUANT80 & CURIOS80', title: 'TOKENOMICS & FAQ', path: '/tokenomics', thumbnail: '/images/DIAMOND_TATTOO.webp' },

    { id: '04', date: 'LIGHT UTIL80', title: 'THE ILLUMIN80', path: '/illumin80', thumbnail: '/images/SKULL_TATTOO.webp' },
    { id: '05', date: 'HI SOCI80', title: 'RL80 FAIRE', path: '/ride', thumbnail: '/images/tiger.webp' },
