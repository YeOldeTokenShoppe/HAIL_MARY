...
export const HOW_TO_PLAY_STEPS = [
  ...
  { num: "2", title: "CLAIM YOUR PLOT", desc: "Before the season starts, pick any open pumpjack — this is your drill site. Here's the fair part: the field is sealed with a tamper-proof commitment before anyone plays, but the actual oil map isn't generated until AFTER every plot is locked in — from a future blockchain event nobody (not even us) can predict. So when you choose, the map doesn't exist yet. You're picking blind, like a real prospector, and it can't be rigged." },
  { num: "3", title: "YOUR RIG PUMPS 24/7", desc: "No clicking required. Once the season is live, your rig drills on its own around the clock and hits 'strikes' at random, unpredictable moments. Check back often to see if you struck oil." },
  { num: "4", title: "DEPTH = RICHES", desc: "Just like real geology, the deeper you go the richer the earth tends to be — you'll find oil at shallower layers too, just less often. Everyone can reach about halfway down; effort, referrals, and loyalty earn extra depth, down to a max of 20. It's not luck — it's strategy and commitment." },
  { num: "5", title: "BANK YOUR OIL", desc: "Drain your tank to bank your haul — banked oil is safe and counts toward the leaderboard. Your payout is your oil × a fixed rate, so your reward depends only on your OWN haul, never on what anyone else finds." },
  { num: "6", title: "BEWARE HELL POCKETS", desc: "Not everything underground is oil. Hell pockets are hidden through the layers below the surface — and the deeper your rig pushes chasing richer oil, the more chances it has to breach one. You can't aim around them, but your gauges may flag unusual activity nearby as a heads-up. Breach one and an evil entity breaks loose: the unlucky driller is frozen for 2 minutes and ALL oil production across the field halts until it's contained. Other players can hunt it down for a bounty paid from the Community Tank — turning one player's bad luck into a field-wide scramble. Your best defense is to bank often: the less un-banked oil you're holding, the less you expose when hell breaks loose." },
