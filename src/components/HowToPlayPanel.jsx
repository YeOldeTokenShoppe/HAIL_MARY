...
import { REFERRAL_BONUS, MAX_BONUS_DRILLS } from "@/lib/oilBonusMath";

// Single source of truth for the rules copy — also consumed by OilWelcomeModal.
export const HOW_TO_PLAY_STEPS = [
  { num: "1", title: "GET YOUR KEY", desc: "Hold around $20 worth of RL80 tokens and follow the RL80 'X' account. Holding the token is your key — no spending required, and you can sell anytime. Once you're in, holding keeps you qualified: snapshots check your balance on-chain, and only selling below your entry position drops you — a price dip never does." },
  ...
  { num: "4", title: "DEPTH = RICHES", desc: `Just like real geology, the deeper you go the richer the earth tends to be — you'll find Betroleum at shallower layers too, just less often. Every rig reaches 10 layers on its own; each friend you refer who claims a plot adds +${REFERRAL_BONUS} layers (up to ${MAX_BONUS_DRILLS} bonus), down to the max of 20. It's not luck — it's strategy and commitment.` },
